...
const Modal = ({ isOpen, setOpen, name, product_id, price }: IModal) => {
    ...
    if (isOpen) {
        return (
            ...
            <div>
                <div id="crud-modal" aria-hidden="true" className="fixed inset-0 flex justify-center items-center w-full md:inset-0 z-50">
                        ...
                        <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                            ...
                            <form className="p-4 md:p-5" onSubmit={handleSubmit}>
                                ...
                                <div className="flex justify-center">
                                    <button type="submit" className="w-40 flex justify-center text-white items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                        Vender
                                    </button>
                                </div>
                            </form>
